...
bot = telebot.TeleBot('7554400807:AAGlQ0m0ehMekY-Q19aMMhgjmxSqKqUjd4w')
...
def handle_soul(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            response = "✅A͢v͢a͢i͢l͢a͢b͢l͢e͢ r͢i͢g͢h͢t͢ n͢o͢w͢✅ :- /attack <king> <Hackking> <time>"  
    else:
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - @Hackerorbot01 ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 W͙e͙l͙c͙o͙m͙e͙ t͙o͙ Hackerworld ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
